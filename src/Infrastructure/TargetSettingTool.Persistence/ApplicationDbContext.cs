...
namespace TargetSettingTool.Persistence
{
    ...
    public class ApplicationDbContext:DbContext
    {
        ...
        public DbSet<User> MstUsers { get; set; }
        public DbSet<Role> MstRoles { get; set; }
        public DbSet<Right> MstRights { get; set; }
        public DbSet<Parameter> MstParameters { get; set; }
        public DbSet<ParameterType> MstParameterTypes { get; set; }
        public DbSet<Branch> MstBranches { get; set; }
        public DbSet<UserParameter> TblUserParameters { get; set; }
        public DbSet<UserBranch> TblUserBranches { get; set; }
        public DbSet<UserParameterHistory> TblUserParameterHistories { get; set; }
        public DbSet<UserBranchHistory> TblUserBranchHistories { get; set; }

        public DbSet<Menu> TblMenu { get; set; }

        public DbSet<BranchTarget> TblBranchTargets { get; set; }

        public DbSet<BranchTargetHistory> TblBranchTargetHistory { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //Computed column EmployeeCode
            modelBuilder.Entity<User>()
                .Property(p => p.EmployeeCode)
                .HasComputedColumnSql("'EMP' + RIGHT(REPLICATE('0', 3) + CAST(EmployeeNumber AS VARCHAR(8)), 3)");

            //Ignore EmployeeNumber and EmployeeCode on Update
            modelBuilder.Entity<User>().Property(u => u.EmployeeNumber).Metadata.SetAfterSaveBehavior(PropertySaveBehavior.Ignore);
            modelBuilder.Entity<User>().Property(u => u.EmployeeCode).Metadata.SetAfterSaveBehavior(PropertySaveBehavior.Ignore);
